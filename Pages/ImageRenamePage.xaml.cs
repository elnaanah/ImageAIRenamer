...
namespace ImageAIRenamer.Pages
{
    public partial class ImageRenamePage : Page
    {
        ...
        private void LoadImages(string folder)
        {
            ...
            StatusText.Text = $"تم تحميل {Images.Count} صورة.";
            CheckReady();
        }
        ...
        private async void Process_Click(object sender, RoutedEventArgs e)
        {
            ...
            StatusText.Text = "اكتملت المعالجة!";
            MessageBox.Show("اكتملت المعالجة!", "نجح", MessageBoxButton.OK, MessageBoxImage.Information);
        }
