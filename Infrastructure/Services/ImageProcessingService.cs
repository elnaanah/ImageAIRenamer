...
public class ImageProcessingService : IImageProcessingService
{
    ...
    public string GenerateUniqueFileName(string baseName, string extension, ConcurrentDictionary<string, int> usedNames)
    {
        var sanitized = baseName;
        var counter = usedNames.AddOrUpdate(sanitized, 0, (key, oldValue) => oldValue + 1);
